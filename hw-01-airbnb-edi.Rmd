...
3.  Run `View(edibnb)` in your Console to view the data in the data viewer. What does each row in the dataset represent?
Each row represents the a house that is on the market.
...
I chose this layout because you can clearly see each neighbourhood but you can also compare the pricing of each neighbourhood by one glance.
 ggplot(data = edibnb, mapping = aes(x = price)) +
    geom_histogram(binwidth = 0.2) +
    facet_wrap(~neighbourhood)
https://46033bcb378a4793bb2348ae39d48003.app.posit.cloud/graphics/4975e29d-6e1f-4493-8082-fefd795878d2.png
``` r
